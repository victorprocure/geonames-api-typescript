...
var CountryCode = (function (_super) {
    ...
    function CountryCode(config) {
        var _this = _super.call(this, 'countryCode', [GeonamesFormat_1.GeonamesFormat.XML, GeonamesFormat_1.GeonamesFormat.JSON, GeonamesFormat_1.GeonamesFormat.TXT]) || this;
        _this.config = config;
        return _this;
    }
